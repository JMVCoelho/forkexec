...
/**
 * Class that tests search Hungry operation
 */
public class SearchHungryIT extends BaseIT {
    ...
    public void correctSearch_ALLMENUS() throws InvalidTextFault_Exception {
        List<Food> foods = client.searchHungry("gelado");

        assertNotNull(foods);
        assertEquals(foods.size(), 4);
        assertEquals(foods.get(0).getPreparationTime(), 12);
    }
    
    @Test
    public void correctSearch_NOTALLMENUS() throws InvalidTextFault_Exception {
        List<Food> foods = client.searchHungry("carne");
    ...
    public void correctSearch_SINGLEMENU() throws InvalidTextFault_Exception {
        ...
        assertEquals(foods.get(0).getPreparationTime(), 25);
    }
