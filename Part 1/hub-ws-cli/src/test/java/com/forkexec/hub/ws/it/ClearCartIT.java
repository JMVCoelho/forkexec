...
public class ClearCartIT extends BaseIT {
    ...
    public void success() throws InvalidUserIdFault_Exception {
        ...
        client.clearCart("test@user");
        food = client.cartContents("test@user");
        assertEquals(food.size(),0);
    }

    @Test(expected = InvalidUserIdFault_Exception.class)
    public void incorrectClear_UnactivatedUser() throws InvalidUserIdFault_Exception {
        client.clearCart("err");
    }
